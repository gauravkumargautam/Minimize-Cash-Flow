...
import { data_management } from './heap.js';
...
onload = function () {
    ...
    let nodes = [];
    let input = [];
    input = ["ABC","GAURAV","HARSH","DEEPAK","HARSHIT","ANURAG","ANMOL","ISHAN","HIMANSHU","ABHISHEK","AKSHIT"];
    for(let i=1;i<=sz;i++)
{ nodes.push({id:i, label:input[i]}); }
    ...
    function solveData() {
        ...
        const pos_heap = new data_management();
        const neg_heap = new data_management();
